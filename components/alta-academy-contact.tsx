            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-4">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-gray-500 dark:text-gray-400">Cooperative Lalla aicha, local N°01, Tlemcen, Algeria</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-gray-500 dark:text-gray-400">altaacademy@implantaly.com</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-gray-500 dark:text-gray-400">+213 6661606706</p>
                </div>
              </div>
            </div>
          </div>
